...
export default function LoginScreen() {
  ...
  // Find your handleLogin function and replace it with this:
  const handleLogin = () => {
    if (userRole === "admin") {
      // Navigates to Approvals inside the admin tab group
      router.replace("/(tabs)/(admin)/AdminRequestScreen");
    } else {
      // Navigates to the Student Portal index inside the user tab group
      router.replace("/(tabs)/(user)/UserDashboard");
    }
  };
  return (
    <KeyboardAvoidingView
